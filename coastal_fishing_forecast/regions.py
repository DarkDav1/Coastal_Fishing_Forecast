...
REGION_CONFIGS = {
    ...
    "river_mouth": RegionConfig(
        slug="river_mouth",
        display_name="Generic River Mouth",
        beach_bias=0.92,
        rocks_bias=0.88,
        jetty_bias=1.05,
        bay_estuary_bias=1.16,
        tide_movement_bias=1.12,
        shelter_bias=1.08,
        exposure_bias=0.88,
    ),
    "tidal_river": RegionConfig(
        slug="tidal_river",
        display_name="Generic Tidal River",
        beach_bias=0.82,
        rocks_bias=0.82,
        jetty_bias=1.08,
        bay_estuary_bias=1.20,
        tide_movement_bias=1.14,
        shelter_bias=1.16,
        exposure_bias=0.82,
    ),
