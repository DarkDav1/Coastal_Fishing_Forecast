...
def _score_factors_prompt(payload: Mapping[str, Any]) -> str:
    return (
        ...
        "Use 2–5 bullets.\n"
        "- negative_factors: bullet strings — concrete drawbacks (deduction-style stresses): slack tide, cold, rain, "
        "strong gusts, rough seas, volatile weather, dull midday periods, weather shocks, weak tide movement, "
        "heavy rain earlier in the trend, etc. "
        "Use 0–5 bullets; prefer pulling subtle negatives from aggregates and weather_change_notes rather than "
        "returning [] when the data hints at any friction.\n"
